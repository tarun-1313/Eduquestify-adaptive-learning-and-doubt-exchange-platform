...
import DoubtsChat from "./doubts-chat"
...
export default function Doubts() {
  ...
  const handleDoubtClick = (doubt) => {
    // Redirect to the chat section displaying all user chats
    window.location.href = `/teacher/chat?doubtId=${doubt.id}`;
  };
          ...
          <Card className="bg-background/80 backdrop-blur-sm border-border/50">
            ...
            <CardContent className="space-y-3">
              <div className="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <div className="font-medium text-blue-800 dark:text-blue-200">@Alex Chen mentioned you</div>
                <div className="text-sm text-blue-600 dark:text-blue-300">2 minutes ago</div>
              </div>
              <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <div className="font-medium text-yellow-800 dark:text-yellow-200">Emma Wilson flagged doubt as urgent</div>
                <div className="text-sm text-yellow-600 dark:text-yellow-300">5 minutes ago</div>
              </div>
              <div className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                <div className="font-medium text-green-800 dark:text-green-200">Sarah Kim's doubt is trending</div>
