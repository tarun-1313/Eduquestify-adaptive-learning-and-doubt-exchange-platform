...
async function testDownloadStatsAPI() {
  try {
    ...
    console.log('Testing download stats API...');
    
    const response = await fetch('http://localhost:3002/api/question-banks/download-stats', {
      method: 'GET',
      headers: {
